...
<div id="shop">
      ...
      <div class="bar">
          ...
          <div>Accessories</div>
          <div>The Keys</div>
          <div><img class="icon" src={'https://cdn4.iconfinder.com/data/icons/gnome-desktop-icons-png/PNG/64/Gnome-Stock-Person-64.png'} alt='icon'  /></div>
          <div><img class="shoppingcart" src={'https://cdn4.iconfinder.com/data/icons/Primo_Icons/PNG/128x128/shopping_bag.png'} alt='shoppingcart'  /></div>
      </div>
